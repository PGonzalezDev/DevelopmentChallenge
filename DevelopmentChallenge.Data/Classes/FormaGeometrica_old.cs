...
{
    public class FormaGeometrica_old
    {
        #region Formas
        ...
        public FormaGeometrica_old(int tipo, decimal ancho)
        {
            Tipo = tipo;
            _lado = ancho;
        }

        public static string Imprimir(List<FormaGeometrica_old> formas, int idioma)
        {
